        ...
        <div class="container headerBar" id="headerBar">
            ...
            <div class="col-xs-12 col-sm-8">
                <ul class="nav navbar-nav activebar">
                    ...
                    <c:if test="${memVO==null}"> <!-- 判斷如果會員登入了就不顯示 "加入我們" -->
                    	<li><a href="<%=request.getRequestURI()%>#joinUs" data-toggle="modal">加入我們</a></li>
                    </c:if>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-2">
                ...
                <c:if test="${memVO==null}">
                    <li><a href='<%=request.getContextPath()%>/front/register.jsp'><span class='glyphicon glyphicon-edit'></span> 註冊</a></li>
                    <li><a href='<%=request.getContextPath()%>/front/login.jsp'><span class='glyphicon glyphicon-log-in'></span> 登入</a></li>
                </c:if>
                <c:if test="${memVO!=null}">
                	<li><a href='<%= request.getContextPath()%>/front/member/memdata.jsp'><span class='glyphicon glyphicon-user'>.<%= memVO.getMem_name()%></span></a></li>
                	
                    <li><a href='<%= request.getContextPath()%>/front/logout.do'><span class='glyphicon glyphicon-log-out'></span>.登出</a></li>
                </c:if>
                </ul>
            </div>
        </div>
