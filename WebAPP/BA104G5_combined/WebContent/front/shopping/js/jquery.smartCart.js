...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" />{product_name}<p class="list-group-item-text">{product_desc}</p>',
        ...
        lang: { // Language variables
            cartTitle: "<img src='images/cart.png' height='30px' />",
            checkout: '查看',
            clear: '清空',
            subtotal: '小計:',
            cartRemove: '×',
            cartEmpty: '購物車是空的!<br />請選擇商品'
        },
        submitSettings: {
        ...
        currencySettings: {
            locales: 'zh-TW', // A string with a BCP 47 language tag, or an array of such strings
            currencyOptions: {
                style: 'decimal',
                currency: 'TWD',
