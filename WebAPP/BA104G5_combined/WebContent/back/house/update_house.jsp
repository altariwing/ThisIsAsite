...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>房屋資料修改 - update_emp_input.jsp</h3>
				<h4>
					<a
	...
	<FORM METHOD="post"
		...
		<table>
			...
			<tr>
				<td>新增時間:</td>
				<td><input type="hidden" name="insert_time" size="45"
					value="${houseVO.insert_time}" />
				<fmt:formatDate value="${houseVO.insert_time}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
			<tr>
				<td>最後修改時間:</td>
				<td><input type="hidden" name="final_update_time" size="45"
					value="${houseVO.final_update_time}" />
				<fmt:formatDate value="${houseVO.final_update_time}"
						pattern="yyyy-MM-dd HH:mm:ss" /></td>
			</tr>
