...
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000001', 'SL00000001' ,'order');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000001', 'SL00000001' ,'order');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000002', 'SL00000001' ,'order');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000002', 'SL00000002' ,'order');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000003', 'SL00000003' ,'order');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000002', 'SL00000003' ,'deliver');
INSERT INTO PRODUCT_ORDER(PDO_NO, MEM_NO, SLR_NO, PDO_STAT) 
VALUES('OD'||(LPAD(to_char(PDO_NO_SEQ.NEXTVAL),8,'0')), 'MB00000002', 'SL00000004' ,'cancel');
-------------------------------------------------------------
...
VALUES('OD00000002', 'PD00000001', 500000000 ,10);
INSERT INTO ORDER_DETAIL(PDO_NO, PRD_NO, ODER_UNI_PRICE, ODER_QUANTITY) 
VALUES('OD00000002', 'PD00000002', 500000000 ,10);
